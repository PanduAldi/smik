...
class Forum extends CI_Controller {
	...
	function add_topik(){
		...
		if(isset($_POST['simpan'])){
			$data = array(
				'oleh'		=> strip_tags($this->input->post('oleh')),
				'email'		=> strip_tags($this->input->post('email')),
				'judul'		=> strip_tags($this->input->post('judul')),
				'text'		=> strip_tags($this->input->post('isitopik'))
				);
	...
	function komen($id){
		...
		if(isset($_POST['kirim'])){
			$data = array(
				'id_forum'	=> strip_tags($this->input->post('id')),
				'oleh'		=> strip_tags($this->input->post('oleh')),
				'komen'		=> strip_tags($this->input->post('komen')),
				'email'		=> strip_tags($this->input->post('email')));
