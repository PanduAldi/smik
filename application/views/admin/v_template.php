    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SMK N 2 ADIWERNA KAB. TEGAL</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('dashboard/prog_keahlian') ?>"><i class="fa fa-book"></i> PROGRAM KEAHLIAN</a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url().'dashboard/staf' ?>">Direktori Staf</a>
                                </li>
                                <li>
